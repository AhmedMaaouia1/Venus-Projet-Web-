        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            ...
            <div class="carousel-caption d-md-block">
              <p class="fadeInUp wow" data-wow-delay=".6s">Grand événement mondial sur mode et beauté</p>
              <h1 class="wow fadeInDown heading" data-wow-delay=".4s">Conférence Mode et Beauté</h1>
              <a href="#" class="fadeInLeft wow btn btn-common btn-lg" data-wow-delay=".6s">participer</a>
              <a href="#" class="fadeInRight wow btn btn-border btn-lg" data-wow-delay=".6s">DETAILS</a>
            </div>
          </div>
          <div class="carousel-item">
            ...
            <div class="carousel-caption d-md-block">
              <p class="fadeInUp wow" data-wow-delay=".6s">Grand événement mondial sur mode et beauté</p>
              <h1 class="wow bounceIn heading" data-wow-delay=".7s">22 incroyable Speakers</h1>
              <a href="#" class="fadeInUp wow btn btn-border btn-lg" data-wow-delay=".8s">voir plus</a>
            </div>
          </div>
          <div class="carousel-item">
            ...
            <div class="carousel-caption d-md-block">
              <p class="fadeInUp wow" data-wow-delay=".6s">Grand événement mondial sur mode et beauté</p>
              <h1 class="wow fadeInUp heading" data-wow-delay=".6s">RÉSERVEZ VOTRE PLACE MAINTENANT !</h1>
              <a href="#" class="fadeInUp wow btn btn-common btn-lg" data-wow-delay=".8s">PARTICIPER</a>
            </div>
          </div>
        </div>
          ...
          <div class="col-xs-12 col-md-6 col-lg-4">
            <div class="about-item">
              ...
              <div class="about-text">
                <h3><a href="#">ÉVÉNEMENT 1</a></h3>
                <p>Lorem ipsum dolor sit amet, consectetuer commodo ligula eget dolor.</p>
                <a class="btn btn-common btn-rm" href="#">voir plus</a>
              </div>
            </div>
          </div>
          <div class="col-xs-12 col-md-6 col-lg-4">
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-3 col-xs-12 work-counter-widget text-center">
            <div class="counter wow fadeInRight" data-wow-delay="0.3s">
              ...
              <p>ESPRIT</p>
              <span>ariena soghra , tunisia </span>
            </div>
          </div>
          <!-- Counter Item -->
          <div class="col-md-6 col-lg-3 col-xs-12 work-counter-widget text-center">
          ...
          <div class="col-md-6 col-lg-3 col-xs-12 work-counter-widget text-center">
            <div class="counter wow fadeInRight" data-wow-delay="0.9s">
              ...
              <p>50 PLACES DISPONIBLES</p>       
              <span>Dépêche-toi!participer</span>
            </div>
          </div>
          <!-- Counter Item -->
          <div class="col-md-6 col-lg-3 col-xs-12 work-counter-widget text-center">
