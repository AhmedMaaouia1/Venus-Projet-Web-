...
<body>
 ...
 <h1 class="text-center text-capitalize">Liste des participants</h1>
...
<th scope='col'> Supprimer </th>
         ...
         <td><?php echo $participant['id_event']; ?></td>
			...
			?>
<a style="margin-left:500; " value="Create PDF" id="btPrint" onclick="createPDF()" href="pdf.php" class="btn btn-primary">pdf</a>
      </form> 
 </tbody>
    ...
    <div class="title_container">
      <h2>envoyer un mail</h2>
            ...
            <form class="d-flex" method="POST" action="envoi_news.php">
              <button class="btn btn" style="background-color:#fd6c9e ; color : white" type="submit">Envoyer Mail</button>
            </form>
