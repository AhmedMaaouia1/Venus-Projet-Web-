...
<div class="row clearfix">
  <div class="">
   <form method="POST"  action="../Controller/ajouter_client.php">
       ...
       <input type="email" name="email" placeholder="Email" required />
          ...
          <div class="row clearfix">
            <div class="">
              ...
              <input type ="text" class="input-field" placeholder="Description Sujet">
              </div>
            </div>
            ...
            <div class="">
              ...
              <textarea type ="text" class="input-field " style="width: 350px; padding-left: 30px" placeholder="Votre Message"> 
</textarea>
              </div>
            </div>
</div>
