<?php
include 'D:/desktop/xmapp/htdocs/venusi/View/connexiondb.php';
include_once 'D:/desktop/xmapp/htdocs/venusi/Model/participant.php';
	...
	class participantC {
		...
		function recupererParticipant($idparticipation){
			$sql="SELECT * from participant where idparticipation=$idparticipation";
			$db = connexiondb::getConnexion();
			try{
